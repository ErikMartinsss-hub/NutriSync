  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.bg,
        elevation: 0,
        leading: IconButton(icon: Icon(Icons.arrow_back_rounded, color: AppColors.textDark), onPressed: () => Navigator.pop(context)),
        centerTitle: true,
        title: Text('Adicionar Refeição', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: AppColors.textDark)),
        actions: [
          Container(
            margin: const EdgeInsets.only(right: 12),
            padding: const EdgeInsets.symmetric(horizontal: 12),
            decoration: BoxDecoration(color: AppColors.card, borderRadius: BorderRadius.circular(20), border: Border.all(color: AppColors.border), boxShadow: AppShadows.card),
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                icon: Icon(Icons.keyboard_arrow_down_rounded, size: 16, color: AppColors.textMid),
                items: [
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text('${f.categoria} • ${f.kcalPer100g.toStringAsFixed(0)} kcal/100g', style: TextStyle(fontSize: 11, color: AppColors.textMid)),
          ...
          if (_selected != null) ...[
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('${_selected!.kcalPer100g.toStringAsFixed(0)} kcal / 100g • Proteína ${_selected!.proteinaPer100g.toStringAsFixed(1)}g', style: TextStyle(fontSize: 11, color: AppColors.textMid)),
                const SizedBox(height: 8),
                Row(children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(color: AppColors.card, borderRadius: BorderRadius.circular(12), boxShadow: AppShadows.card),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Adicionar Manualmente', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: AppColors.textDark)),
              const SizedBox(height: 12),
              TextField(
                controller: _nameCtrl,
                decoration: InputDecoration(hintText: 'ex: Pão francês', labelText: 'Nome do alimento', border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)), prefixIcon: Icon(Icons.restaurant_rounded, size: 18, color: AppColors.textMid)),
              ),
              const SizedBox(height: 12),
              TextField(
                controller: _kcalCtrl,
                keyboardType: TextInputType.number,
                decoration: InputDecoration(hintText: 'ex: 135 kcal', labelText: 'Calorias (kcal)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)), prefixIcon: Icon(Icons.local_fire_department_rounded, size: 18, color: AppColors.textMid)),
              ),
            ]),
          ),
