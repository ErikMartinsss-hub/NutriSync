      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Icon(Icons.chevron_right_rounded, size: 18, color: AppColors.textMid),
          ]),
          const SizedBox(height: 12),
          Row(children: [
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Atual', style: AppText.small), Text('${current.toStringAsFixed(1)} kg', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: AppColors.textDark))])),
            Container(width: 1, height: 36, color: AppColors.border),
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [Text('Meta', style: AppText.small), Text('${target.toStringAsFixed(1)} kg', style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: AppColors.primary))])),
            Container(width: 1, height: 36, color: AppColors.border),
          ...
          Text('${(progress * 100).toStringAsFixed(0)}% concluído', style: TextStyle(fontSize: 11, color: AppColors.textMid)),
        ]),
      ),
    );
  }
